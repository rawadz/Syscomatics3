...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    footer: { 
        sub: 'Architecting sovereign digital futures.', 
        nav: 'Navigation', 
        exp: 'Expertise', 
        ...
        opsHub: 'Operational Hub',
        voiceLink: 'Voice Link',
        correspondence: 'Correspondence',
        link1: 'Engineering Solutions',
        link2: 'Strategy Roadmap',
        link3: 'Transformation Stories',
        copyright: 'Syscomatics Global Systems',
  ...
  ar: {
    ...
    hero: { 
      ...
      cta1: 'استكشف حلولنا', 
      cta2: 'رؤيتنا الاستراتيجية' 
    },
    about: { 
      badge: 'مسار التنفيذ', 
      title: 'بساطة. وضوح.', 
      accent: 'نتائج ملموسة.', 
      sub: 'ثلاث خطوات تقنية لتعزيز نمو أعمالك وضمان تفوقها.',
      steps: [
        { title: 'نصغي', desc: 'نبدأ بفهم أهدافك والتحديات التي تواجه أعمالك بعمق.', img: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=1000' },
        { title: 'نبني', desc: 'يقوم مهندسونا بابتكار معمارية رقمية مخصصة لاحتياجاتك.', img: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=1000' },
        { title: 'تقود', desc: 'تتولى السيطرة الكاملة على نظام قوي، آمن، وقابل للتوسع.', img: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1000' }
      ],
      uptime: 'جاهزية دائمة', 
      uptimed: 'أنظمة عالية السرعة تضمن استمرارية أعمالك دون أي انقطاع.',
      uptimeLabel: '٩٩.٩٪ توفر النظام'
    },
    services: { 
      header: 'حلولنا التقنية', 
      sub: 'أدوات ذكية مصممة لتلبية متطلبات الشركات الحديثة.', 
      back: 'العودة', 
      spec: 'الخبرة في مجال', 
      pillars: 'لماذا سيسكوماتيكس؟', 
      pillarsSub: 'أسس هندسية تضمن القابلية للتوسع، الأمان السيبراني، والتميز التشغيلي.',
      roadmap: 'خارطة الطريق الاستراتيجية', 
      thesis: 'الأطروحة الهندسية', 
      value: 'القيمة الاستراتيجية للأعمال', 
    ...
    inquiry: { 
      ...
      successSub: 'سنتواصل معك قريباً لمراجعة المتطلبات الفنية لمشروعك.', 
    ...
    footer: { 
        sub: 'هندسة مستقبل رقمي سيادي ومستدام.', 
        nav: 'التنقل', 
        exp: 'مجالات الخبرة', 
        newsletter: 'النشرة البريدية', 
        newsd: 'احصل على آخر التحديثات التقنية.', 
        reg: 'انضم إلينا', 
        contact: 'تواصل معنا', 
        address: 'دمشق، سوريا', 
        email: 'info@syscomatics.com', 
        phone: '+963 932 255 512',
        opsHub: 'المركز التشغيلي',
        voiceLink: 'رابط الاتصال',
        correspondence: 'المراسلات الرسمية',
        link1: 'حلول الهندسة الرقمية',
        link2: 'خارطة الاستراتيجية',
        link3: 'قصص التحول والنجاح',
        copyright: 'سيسكوماتيكس للأنظمة العالمية',
        founder: 'تأسست من قبل رواد زيتون',
        version: 'مركز دمشق التقني | V.2.5.0'
    },
    cookie: { title: 'بروتوكول الأنظمة', desc: 'نحن نستخدم تقنيات التخزين المحلي لضمان استمرار ملخص مشروعك وتفضيلات اللغة الخاصة بك عبر الجلسات المختلفة.', accept: 'قبول البروتوكول', reject: 'رفض' }
  },
  ku: {
    ...
    footer: { 
        sub: 'Avakirina paşerojên dîjîtal ên serwer.', 
        nav: 'Navîgasyon', 
        exp: 'Pisporî', 
        newsletter: 'Abone Bibe', 
        newsd: 'Nûçeyan bistînin.', 
        reg: 'Tevlî Me Bibe', 
        contact: 'Têkilî', 
        address: 'Şam, Sûriye', 
        email: 'info@syscomatics.com', 
        phone: '+963 932 255 512',
        opsHub: 'Navenda Operasyonê',
        voiceLink: 'Girêdana Dengî',
        correspondence: 'Peywendî',
        link1: 'Çareseriyên Endezyariyê',
        link2: 'Nexşerêya Stratejîk',
        link3: 'Çîrokên Veguherînê',
        copyright: 'Syscomatics Global Systems',

  ...
  return (
    <section id="services" className="py-32 px-6 md:px-12 bg-white">
      <div className="max-w-[1440px] mx-auto">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-24 gap-12 text-start">
          <div className="max-w-2xl">
            <div className="h-1 w-16 bg-[#0037f3] mb-8"></div>
            <h2 className="text-4xl md:text-7xl font-heading font-extrabold text-[#0a0b0d] tracking-tighter mb-6">
                {t.header}
            </h2>
            <p className="text-xl text-gray-400 font-medium">{t.sub}</p>
          </div>
